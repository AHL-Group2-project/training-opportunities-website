...
function PendingRequestsPage() {
    const [requests, setRequests] =
        useState<InternshipRequest[]>(requestsMock);
    ...
    const [selectedTab, setSelectedTab] =
        useState<RequestTab>("Pending");

    const [selectedType, setSelectedType] =
        useState<TrainingType | "All">("All");
    ...
    const filteredRequests = useMemo(() => {
        return requests.filter((request) => {
            ...
            const matchesType =
                selectedType === "All" ||
                request.trainingType === selectedType;

            const matchesStartDate =
                !startDate || request.submittedDate >= startDate;

            const matchesEndDate =
                !endDate || request.submittedDate <= endDate;
            ...
            currentRequests.map((request) =>
                request.id === selectedRequest.id
                    ? {
                        ...
                        status,
                        rejectionComment:
                            status === "Rejected" ? comment : undefined,
                    }
                    : request,
            ),
        );
        ...
        >
            ...
            <Box sx={{ mb: 3 }}>
                ...
                <Typography color="text.secondary">
                    Review students&apos; internship requests and track
            ...
            >
                ...
                >
                    <Tabs
                        value={selectedTab}
                        onChange={(_, newValue: RequestTab) =>
                ...
                >
                    ...
                    >
                        ...
                        <Select
                            ...
                            onChange={(event) =>
                                setSelectedType(
                                    event.target.value as TrainingType | "All",
                                )
                            }
                        >
                ...
                {filteredRequests.length > 0 ? (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <Chip
                                                    ...
                                                    sx={{
                                                        color:
                                                            statusStyles[request.status].color,
                                                        backgroundColor:
                    ...
                    >
                        ...
                        <Typography variant="body2" color="text.secondary">
                            There are no internship requests matching the
                            selected filters.
                        </Typography>
                    </Box>
                )}
                        ...
                        <DialogContent sx={{ p: 3 }}>
                            ...
                            <Box sx={{ mt: 3 }}>
                                ...
                                <Chip
                                    ...
                                    sx={{
                                        color:
                                            statusStyles[selectedRequest.status].color,
                                        backgroundColor:
